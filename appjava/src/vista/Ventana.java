...
public class Ventana extends javax.swing.JFrame {
    private final RepositorioMysql daomysql;
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        int cantidad = daomysql.obtenerCantidadPersonas();
        JOptionPane.showMessageDialog(null, "la Cantidad en Mysql es :" + cantidad);
    }//GEN-LAST:event_jButton2ActionPerformed

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        String id = ctBuscar.getText();
        Persona p = daomysql.buscarPersona(id);
        JOptionPane.showMessageDialog(null, p.getNombre()+ " " + p.getApellido());
